...
Make alluvial plots with node order and colors optimized to minimize edge crossings with wompwomp! Builds on top of the sorting algorithm in [wompwomp](https://github.com/pachterlab/wompwomp).
