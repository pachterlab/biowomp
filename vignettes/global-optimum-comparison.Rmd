...
```{r}
# devtools::load_all("/Users/joeyrich/Desktop/local/biowomp")
# devtools::load_all("/Users/joeyrich/Desktop/local/wompwomp")
...
wompwomp_objective_greedy_wolf <- determine_crossing_edges(clus_df_gather_sorted, graphing_columns = c("col1_int", "col2_int"))$output_objective
...
for (i in 1:nrow(perms)) {
    ...
    clus_permuted_objective <- determine_crossing_edges(clus_permuted, graphing_columns = c("col1_int", "col2_int"))$output_objective
...
wompwomp_objective_greedy_wblf <- determine_crossing_edges(clus_df_gather_sorted, graphing_columns = c("col1_int", "col2_int"))$output_objective
...
for (i in 1:nrow(left_perms)) {
    ...
    for (j in 1:nrow(right_perms)) {
        ...
        # Compute objective
        obj <- determine_crossing_edges(clus_permuted, graphing_columns = c("col1_int", "col2_int"))$output_objective
        objectives[i, j] <- obj
...
tsp_objective_minimum <- determine_crossing_edges(clus_df_gather_sorted_tsp, graphing_columns = c("col1_int", "col2_int"))$output_objective
