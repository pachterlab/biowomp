...
```{r}
# devtools::load_all("~/Desktop/local/biowomp")
...
crossing_edges_output_unsorted <- determine_crossing_edges(clus_df_gather_ungrouped, graphing_columns = c("col1_int", "col2_int"), column_weights = "value")
objective_unsorted <- crossing_edges_output_unsorted$output_objective
print(paste0("Objective (unsorted): ", objective_unsorted))

crossing_edges_output_wolf <- determine_crossing_edges(clus_df_gather_sorted_wolf, graphing_columns = c("col1_int", "col2_int"), column_weights = "value")
objective_wolf <- crossing_edges_output_wolf$output_objective
print(paste0("Objective (greedy WOLF): ", objective_wolf))

crossing_edges_output_wblf <- determine_crossing_edges(clus_df_gather_sorted_wblf, graphing_columns = c("col1_int", "col2_int"), column_weights = "value")
objective_wblf <- crossing_edges_output_wblf$output_objective
print(paste0("Objective (greedy WBLF): ", objective_wblf))

crossing_edges_output_nn <- determine_crossing_edges(clus_df_gather_sorted_nn, graphing_columns = c("col1_int", "col2_int"), column_weights = "value")
